(()=>{
  const apply=()=>{
    ...
    if(b)b.textContent='FTF LIVE v58';
    document.documentElement.dataset.ftfBuild='58';
  };
  ...
  const loadGuard=()=>{
    ...
    s.src='./ftf-full-track-playback.js?force=58';
    s.async=false;
    document.body.appendChild(s);
    if(!document.getElementById('ftfBigoDirectLoader')){const b=document.createElement('script');b.id='ftfBigoDirectLoader';b.src='./ftf-bigo-direct.js?force=58';b.async=false;document.body.appendChild(b);}
  };
  ...
  if('serviceWorker' in navigator){
    navigator.serviceWorker.register('./sw.js?force=58').then(reg=>reg.update()).catch(()=>{});
  }
})();
