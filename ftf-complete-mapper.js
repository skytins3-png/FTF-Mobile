(()=>{
  ...
  const AVAILABLE_SCENES={1:174,2:30,3:18,8:26};
  ...
  window.ftfComicAvailableScenes=Object.freeze({...AVAILABLE_SCENES});
  window.showComic=async function(n,cut){
    ...
    const src=`${BASE}FTF-${String(n).padStart(2,'0')}/${String(sceneNumber).padStart(2,'0')}.${ext}?v=214`;
